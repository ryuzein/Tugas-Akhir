    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Tambah Cabang</h6><button aria-label="Close" class="btn-close"
                    data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="cabang" class="form-label">Nama Cabang <span class="text-danger">*</span></label>
                    <input type="text" name="cabang" class="form-control" placeholder="">
                </div>
                <div class="form-group">
                    <label for="kode" class="form-label">Kode Cabang</label>
    ...
    <script>
        function checkForm() {
            ...
            if (cabang == "") {
                ...
                $("input[name='cabang']").addClass('is-invalid');
                setLoading(false);
                return false;
            } else {
                submitForm();
        ...
        function resetValid() {
            $("input[name='cabang']").removeClass('is-invalid');
        };
